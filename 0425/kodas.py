...
labelsPath = "../roomcontrol/coco.names"
LABELS = open(labelsPath).read().strip().split("\n")

weights_path = "../roomcontrol/yolov4-tiny.weights"
config_path = "../roomcontrol/yolov4-tiny.cfg"
...
def aptikimas():
    ...
    cap = cv2.VideoCapture("../roomcontrol/vidcut.mp4")
...
def facemask():
    ...
    webcam = cv2.VideoCapture("../roomcontrol/kaukecut.mp4") #Use video file
    #webcam = cv2.VideoCapture(0)
    classifier = cv2.CascadeClassifier('../roomcontrol//haarcascade_frontalface_default.xml')
    facemask_model=load_model("../roomcontrol/model.h5")
    counter = 0
    while True:
        counter = 30
        has_mask = 0
